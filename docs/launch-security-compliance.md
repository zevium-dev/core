...
| GitHub                        | Source, vulnerability reports, CI metadata and secrets handoff                                         | Org MFA, least privilege, branch protection, audit-log retention, secret-scanning settings, DPA/terms                                | Engineering Lead         | Blocked—org evidence absent                             |
...
- No evidence of GitHub branch protection/CODEOWNERS, required human review,
  signed commits, secret scanning, or production-environment reviewer rules.
