...
- id: "@tanstack/devtools#devtools-app-setup"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/devtools#devtools-app-setup"
...
- id: "@tanstack/devtools#devtools-marketplace"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/devtools#devtools-marketplace"
...
- id: "@tanstack/devtools#devtools-plugin-panel"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/devtools#devtools-plugin-panel"
...
- id: "@tanstack/devtools#devtools-production"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/devtools#devtools-production"
...
- id: "@tanstack/devtools-event-client#devtools-bidirectional"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/devtools-event-client#devtools-bidirectional"
...
- id: "@tanstack/devtools-event-client#devtools-event-client"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/devtools-event-client#devtools-event-client"
...
- id: "@tanstack/devtools-event-client#devtools-instrumentation"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/devtools-event-client#devtools-instrumentation"
...
- id: "@tanstack/devtools-vite#devtools-vite-plugin"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/devtools-vite#devtools-vite-plugin"
...
- id: "@tanstack/react-start#lifecycle/migrate-from-nextjs"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/react-start#lifecycle/migrate-from-nextjs"
...
- id: "@tanstack/react-start#react-start"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/react-start#react-start"
...
- id: "@tanstack/react-start#react-start/server-components"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/react-start#react-start/server-components"
...
- id: "@tanstack/router-core#router-core"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core"
...
- id: "@tanstack/router-core#router-core/auth-and-guards"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/auth-and-guards"
...
- id: "@tanstack/router-core#router-core/code-splitting"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/code-splitting"
...
- id: "@tanstack/router-core#router-core/data-loading"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/data-loading"
  for: "Route loader option, loaderDeps for cache keys, staleTime/gcTime/ defaultPreloadStaleTime SWR caching, pendingComponent/pendingMs/ pendingMinMs, errorComponent/onError/onCatch, beforeLoad, router context and createRootRouteWithContext DI pattern, router.invalidate, Await component, deferred data loading with unawaited promises."
- id: "@tanstack/router-core#router-core/navigation"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/navigation"
...
- id: "@tanstack/router-core#router-core/not-found-and-errors"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/not-found-and-errors"
...
- id: "@tanstack/router-core#router-core/path-params"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/path-params"
...
- id: "@tanstack/router-core#router-core/search-params"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/search-params"
...
- id: "@tanstack/router-core#router-core/ssr"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/ssr"
...
- id: "@tanstack/router-core#router-core/type-safety"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-core#router-core/type-safety"
  for: "Full type inference philosophy (never cast, never annotate inferred values), Register module declaration, from narrowing on hooks and Link, strict:false for shared components, getRouteApi for code-split typed access, addChildren with object syntax for TS perf, LinkProps and ValidateLinkOptions type utilities, as const satisfies pattern."
- id: "@tanstack/router-plugin#router-plugin"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/router-plugin#router-plugin"
...
- id: "@tanstack/start-client-core#start-core"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/start-client-core#start-core"
...
- id: "@tanstack/start-client-core#start-core/auth-server-primitives"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/start-client-core#start-core/auth-server-primitives"
...
- id: "@tanstack/start-client-core#start-core/deployment"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/start-client-core#start-core/deployment"
...
- id: "@tanstack/start-client-core#start-core/execution-model"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/start-client-core#start-core/execution-model"
...
- id: "@tanstack/start-client-core#start-core/middleware"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/start-client-core#start-core/middleware"
...
- id: "@tanstack/start-client-core#start-core/server-functions"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/start-client-core#start-core/server-functions"
...
- id: "@tanstack/start-client-core#start-core/server-routes"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/start-client-core#start-core/server-routes"
...
- id: "@tanstack/start-server-core#start-server-core"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/start-server-core#start-server-core"
...
- id: "@tanstack/virtual-file-routes#virtual-file-routes"
  run: "pnpm dlx @tanstack/intent@0.3.6 load @tanstack/virtual-file-routes#virtual-file-routes"
