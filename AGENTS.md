...
- **Payments**: Stripe Checkout for credit top-ups + Stripe Connect for publisher onboarding/transfers. Webhooks project payment and payout facts into Convex; Convex remains credit-ledger truth
