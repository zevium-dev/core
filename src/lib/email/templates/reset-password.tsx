                ...
                <tr>
                  <td align="center" className="p-[40px] text-center">
                    ...
                    <Heading
                      as="h1"
                      className={`
                      m-0 mt-[4px] font-bold text-white
                    `}
                    >
                      Reset your password
                    </Heading>
                    <Text
                      className={`
                      m-0 mt-[8px] text-[16px] leading-[24px] text-white
                    `}
                    >
                    ...
                    <Button
                      className={`
                        mt-[24px] rounded-[8px] border border-solid
                        border-gray-200 bg-white px-[40px] py-[12px]
                    ...
                    <Text
                      className={`
                      m-0 mt-[12px] text-[14px] leading-[20px] text-gray-200
                    `}
                    >
