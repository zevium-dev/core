          ...
          {Array.from({ length: 5 }).map(() => (
            <div className="flex items-start space-x-3" key={crypto.randomUUID()}>
              ...
              <div className="flex-1 space-y-1">
                <p className="text-sm">
                  Sample activity - This is a placeholder for actual activity data
                </p>
        ...
        <CardContent>
          <div className="space-y-4">
            {Array.from({ length: 3 }).map(() => (
              <div className="flex items-center justify-between p-4 border rounded-lg" key={crypto.randomUUID()}>
                <div className="space-y-2">
      ...
      <CardContent>
        <div className="space-y-4">
          {projects.map((project) => (
            <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors" key={project.id}>
              <div className="space-y-1">
...
function RouteComponent() {
  ...
  const { data: organizationData, error, isLoading } = useQuery({
        ...
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              {error instanceof Error ? error.message : "The organization you're looking for doesn't exist or you don't have access to it."}
            </p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Manage your organization, team members, and projects
              </p>
            </div>
